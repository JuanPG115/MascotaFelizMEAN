...
//@authenticate("admin")
//@authenticate.skip() -> si autentico toda la clase -> omite el metodo que tenga esto.
export class UsuarioController {
  ...
  async create(
    ...
    //Notificar al nuevo usuario del sistema - correo - cel
    //Correo
    ...
    fetch(`http://localhost:5000/email?correo_destino=${destino}&asunto=${asunto}&contenido=${contenido}`)
      .then((data: any) => {
        console.log(data);
      })
    return u;
